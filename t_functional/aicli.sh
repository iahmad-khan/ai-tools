...
cat $IN | ai-foreman --config $CONF addhost -c playground/ibarrien/test1 -e qa -a x86_64 -p "Kickstart default" -o "SLC 6.6" -r
echo "Showhost..."
...
ai-foreman --config $CONF updatehost -o "CentOS 7.0" aifcliftest11.cern.ch -y
